odoo.define('planning_copy_month.PlanningGanttController', function (require) {
'use strict';

var planningXX = require('planning.PlanningGanttController')
...
var PlanningGanttController = GanttController.extend({
    events: _.extend({}, GanttController.prototype.events, {
        ...
        'click .o_gantt_button_copy_previous_month': '_onCopyMonthClicked',
    }),
    ...
    _onCopyMonthClicked: function (ev) {
        console.log('CORE TEST Month')
        ev.preventDefault();
        var state = this.model.get();
        var self = this;

        console.log(self.model.convertToServerTime(state.startDate))
    ...
    _onScaleClicked: function (ev) {
        ...
        if (scale !== 'week') {
            ...
            this.$('.o_gantt_button_copy_previous_month').hide();
            if (scale == 'month'){
                this.$('.o_gantt_button_copy_previous_month').show();
                }
        }
        else {
